...
SOURCEFILES_QUOTED_IF_SPACED=ADC_Libreria.c Configuracion.c Interrupcion.c LCD_Libreria.c Programa_principal.c PWM.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/ADC_Libreria.p1 ${OBJECTDIR}/Configuracion.p1 ${OBJECTDIR}/Interrupcion.p1 ${OBJECTDIR}/LCD_Libreria.p1 ${OBJECTDIR}/Programa_principal.p1 ${OBJECTDIR}/PWM.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/ADC_Libreria.p1.d ${OBJECTDIR}/Configuracion.p1.d ${OBJECTDIR}/Interrupcion.p1.d ${OBJECTDIR}/LCD_Libreria.p1.d ${OBJECTDIR}/Programa_principal.p1.d ${OBJECTDIR}/PWM.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/ADC_Libreria.p1 ${OBJECTDIR}/Configuracion.p1 ${OBJECTDIR}/Interrupcion.p1 ${OBJECTDIR}/LCD_Libreria.p1 ${OBJECTDIR}/Programa_principal.p1 ${OBJECTDIR}/PWM.p1

# Source Files
SOURCEFILES=ADC_Libreria.c Configuracion.c Interrupcion.c LCD_Libreria.c Programa_principal.c PWM.c
...
dist/${CND_CONF}/${IMAGE_TYPE}/ADC_PWM.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/ADC_PWM.X.${IMAGE_TYPE}.map  -D__DEBUG=1  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto        $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/ADC_PWM.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/ADC_PWM.X.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/ADC_PWM.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/ADC_PWM.X.${IMAGE_TYPE}.map  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/ADC_PWM.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
